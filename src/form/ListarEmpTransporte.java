 ...
 * @author RavenPC
 */
public class ListarEmpTransporte extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listado de Empresas de Transporte");
        ...
        btnshpAgregarCliente.setBounds(280, 512, 211, 63);
        ...
        btnshpVolverCliente.setBounds(521, 512, 211, 63);
        ...
        JLabel lblRUT = new JLabel("Comuna donde Trabaja:");
        lblRUT.setForeground(new Color(3, 33,  57));
        lblRUT.setBounds(49, 59, 231, 33);
        ...
        scrollPane.setBounds(10, 114, 753, 367);
        add(scrollPane);
        
        RSTableMetroCustom tblCliente = new RSTableMetroCustom();
        tblCliente.setFontRowSelect(new Font("Tahoma", Font.BOLD, 11));
        tblCliente.setFontHead(new Font("Dubai", Font.BOLD, 14));
        tblCliente.setShowHorizontalLines(true);
        tblCliente.setColorSecundaryText(new Color(25, 25, 112));
        ...
        tblCliente.setModel(new DefaultTableModel(
        	...
        	new String[] {
        		"ID EMPRESA", "NOMBRE DEL CONDUCTOR", "TIPO VEHICULO", "COMUNA", "DISPONIBLE DESDE"
        	}
        ));
        tblCliente.getColumnModel().getColumn(1).setPreferredWidth(193);
        tblCliente.getColumnModel().getColumn(2).setPreferredWidth(96);
        tblCliente.getColumnModel().getColumn(3).setPreferredWidth(97);
        tblCliente.getColumnModel().getColumn(4).setPreferredWidth(115);
        ...
        comboBox.setModel(new DefaultComboBoxModel(new String[] {"SANTIAGO", "VALDIVIA", "VI\u00D1A DEL MAR"}));
        comboBox.setForeground(new Color(25, 25, 112));
        comboBox.setColorFondo(new Color(255, 255, 255));
        comboBox.setBounds(290, 61, 181, 32);
        add(comboBox);
