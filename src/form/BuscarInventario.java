 ...
 * @author RavenPC
 */
public class BuscarInventario extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Buscar Activos Fijos / Comodidades");
        ...
        btnshpAgregarCliente.addActionListener(new ActionListener() {
        	...
        	public void actionPerformed(ActionEvent e) {
            	...
            	MainMenu.panelBody.add(new ModificarInventario(nombre_inv));
        ...
        btnshpAgregarCliente.setText("   MODIFICAR");
        btnshpAgregarCliente.setIcon(FontIcon.of(FontAwesomeSolid.PENCIL_ALT, 40, Color.white));
        ...
        btnshpBuscar.setBounds(438, 56, 140, 42);
        add(btnshpBuscar);
        ...
        tblCliente.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent arg0) {
        		...
        		nombre_inv = model.getValueAt(tblCliente.getSelectedRow(), 1).toString();
        		System.out.println("El Producto seleccionado es es: "+nombre_inv);
