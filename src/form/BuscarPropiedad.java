...
public class BuscarPropiedad extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Buscar Propiedades");
        ...
        btnshpAgregarCliente.addActionListener(new ActionListener() {
        	...
        	public void actionPerformed(ActionEvent e) {
            	...
            	MainMenu.panelBody.add(new ModificarPropiedad(rol));
        ...
        JLabel lblRUT = new JLabel("ROL Propiedad:");
        lblRUT.setForeground(new Color(3, 33,  57));
        lblRUT.setBounds(68, 59, 158, 33);
        ...
        btnshpBuscar.setBounds(404, 56, 140, 42);
        add(btnshpBuscar);
