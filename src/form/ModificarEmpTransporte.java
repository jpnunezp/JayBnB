 ...
 * @author RavenPC
 */
public class ModificarEmpTransporte extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registrar una Empresa de Transporte");
        ...
        btnshpAgregarCliente.addActionListener(new ActionListener() {
        	...
        	public void actionPerformed(ActionEvent e) {
        		JOptionPane.showMessageDialog(null, "LA EMPRESA DE TRANSPORTE FUE ACTUALIZADA EXITOSAMENTE", "MENSAJE", JOptionPane.INFORMATION_MESSAGE);      	
        ...
        btnshpAgregarCliente.setBounds(295, 464, 211, 63);
        ...
        btnshpBuscarCliente.setBounds(520, 464, 211, 63);
        ...
        JLabel lblApellidoPaterno = new JLabel("Nombre del Conductor:");
        ...
        JLabel lblApellidoAterno = new JLabel("Tipo de Veh\u00EDculo:");
        ...
        lblApellidoAterno.setBounds(54, 231, 186, 33);
        ...
        lblFechaDeNacimiento.setBounds(54, 338, 186, 33);
        ...
        dateChooser.setBounds(264, 338, 166, 42);
        add(dateChooser);
        ...
        comboBox.setModel(new DefaultComboBoxModel(new String[] {"AUTOMOVIL", "FURGON"}));
        ...
        comboBox.setBounds(264, 232, 200, 32);
        add(comboBox);
        ...
        lblComuna.setBounds(10, 285, 230, 33);
        add(lblComuna);
        ...
        comboBox_1.setBounds(264, 286, 200, 32);
        add(comboBox_1);
        
        JLabel lblIdDeLa = new JLabel("ID de la Empresa:");
        lblIdDeLa.setHorizontalAlignment(SwingConstants.RIGHT);
        lblIdDeLa.setForeground(new Color(3, 33, 57));
        lblIdDeLa.setFont(new Font("Dubai", Font.BOLD, 20));
        lblIdDeLa.setBounds(0, 73, 240, 33);
        add(lblIdDeLa);
        ...
        lblIDEmpresa.setBounds(264, 73, 240, 33);
        add(lblIDEmpresa);
