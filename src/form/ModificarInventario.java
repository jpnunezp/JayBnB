...
public class ModificarInventario extends javax.swing.JPanel {
     ...
     */
    public ModificarInventario(String nombre_inv) {
    	setBackground(new Color(255, 255, 255));
        initComponents(nombre_inv);
    }
    ...
    private void initComponents(String nombre_inv) {

    	Inventario minv = new Inventario();
    	
    	minv = traerPropiedad(nombre_inv);
        ...
        txtNombre.setText(minv.getNombre());
        add(txtNombre);
        ...
        txtCosto.setText(String.valueOf(minv.getCosto()));
        add(txtCosto);
    ...
    public Inventario traerPropiedad(String nombre_inv) {
		ConectInventario cinv = new ConectInventario();
    	inv = cinv.buscarInventario(nombre_inv);	
