 ...
 * @author RavenPC
 */
public class ListarEmpTurismo extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblCliente.setModel(new DefaultTableModel(
        	...
        	new String[] {
        		"ID EMPRESA", "NOMBRE DEL CONTACTO", "COMUNA", "DISPONIBLE DESDE"
        	}
        ));
        tblCliente.getColumnModel().getColumn(1).setPreferredWidth(193);
        tblCliente.getColumnModel().getColumn(2).setPreferredWidth(97);
        tblCliente.getColumnModel().getColumn(3).setPreferredWidth(115);
